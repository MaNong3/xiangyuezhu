 ...
 * @Date: 2019-02-27 13:47:56 
 * @Last Modified by:   mikey.liujiaxu 
 * @Last Modified time: 2019-02-27 13:47:56 
 */
<template>
    <div class="detail">
        <Header :title="title"/>
        <section>
            <div class="sec-detail">
                <dl>
                    <dt>
                        <img :src="detailData.photos" alt="">
                    </dt>
                    <dd>
                        <p class="name">
                            <span>{{detailData.shortName}}</span>
                            <span>{{detailData.subTitle}}</span>
                        </p>
                        <p class="button"><span>加入结算单</span></p>
                    </dd>
                </dl>
            </div>
        </section>
